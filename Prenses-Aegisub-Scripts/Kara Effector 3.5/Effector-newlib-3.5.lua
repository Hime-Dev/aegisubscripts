	...
	----------------------------------------------------------------------------------------------------------------
	--[[ El archivo Effector-newlib-3.5.lua  ha sido creado con la intención de poder almacenar todas esas variables
